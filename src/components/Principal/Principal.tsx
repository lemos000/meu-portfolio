  ...
  return (
    <div>
      ...
      <div className="p-10 text-center bg-black text-white">
       ...
       <p className=" lg:px-72 py-14">Sou um estudante de Análise e Desenvolvimento de Sistemas na FIAP, trilhando meu caminho no universo da tecnologia da informação. 
